...
<head>
    ...
    <!-- Custom CSS for Animation, Background Image, and Enhanced Blur Effect -->
    <style>
        body, html {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <!-- Edit form with values populated for editing -->
      <form:form action="${pageContext.request.contextPath}/updateIngredient" method="post" modelAttribute="edit_ingredientobj" enctype="multipart/form-data" class="form">

            <a href="${pageContext.request.contextPath}/productAdmin" class="text-primary-emphasis">Home</a>
            
            <input type="hidden" name="id" value="${edit_ingredientobj.id}" />
            ...
            <div class="form-group">
                ...
                <form:input path="photoPath" name="photo" class="form-control-file" multiple="multiple" type="file" />
