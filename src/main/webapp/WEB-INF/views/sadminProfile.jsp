...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url('${pageContext.request.contextPath}/resources/img/p4bg.jpg') no-repeat center center fixed;
...
<div class="container">
    <div class="profile-header">
        <form:form modelAttribute="admin" action="${pageContext.request.contextPath}/supdateProfile" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <h1>Admin Profile</h1>
    ...
    <a href="${pageContext.request.contextPath}/gosell_admin" class="btn btn-danger mt-3 w-100">Back</a>
</div>
