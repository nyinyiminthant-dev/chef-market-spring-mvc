...
<body>
    <div class="container form-container shadow-lg">
        ...
        <form:form action="${pageContext.request.contextPath}/updateProduct" method="post" modelAttribute="product" enctype="multipart/form-data" onsubmit="return validateForm()" class="needs-validation">
